...
{
	this->buttons["GAME_STATE"] = new gui::Button(850.f, 200.f, 250.f, 65.f,
	...
	this->buttons["SETTINGS_STATE"] = new gui::Button(850.f, 300.f, 250.f, 65.f,
		&this->font, "Settings", 50,
		sf::Color(100, 100, 100, 200), sf::Color(250, 250, 250, 250), sf::Color(20, 20, 20, 50),
		sf::Color(100, 100, 100, 0), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 0));

	this->buttons["EDITOR_STATE"] = new gui::Button(850.f,400.f, 250.f, 65.f,
		&this->font, "Editor", 50,
		sf::Color(100, 100, 100, 200), sf::Color(250, 250, 250, 250), sf::Color(20, 20, 20, 50),
		sf::Color(100, 100, 100, 0), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 0));


	this->buttons["EXIT_STATE"] = new gui::Button(300.f,820.f, 250.f, 65.f,
		&this->font, "Quit", 50,
